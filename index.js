 ...
 * it will return `This is a Lincoln Navigator`.
*/
const getCarInfoById = (inventory, index) => {
  /* code here */
...
// CHORE: Implement a selection sort or a quick sort in JS

function sortCarInventory(arr) {
  /* code here */
  return arr.sort((carA, carB) => {

    const modelA = carA.car_model.toUpperCase()
    const modelB = carB.car_model.toUpperCase()
...
function getModelYears(inventory) {
  /* code here */
  // const carYears = Array(inventory.length)

  // for (const car in inventory) {
  //   carYears[car] = inventory[car].car_year
  // }

  // return carYears

  return Array.from(inventory, ({ car_year }) => car_year)
}
